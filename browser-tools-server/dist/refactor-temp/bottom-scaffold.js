...
import { getAvailablePort, clearAllLogs } from './top-scaffold.js';
/**
 * Server startup and initialization logic
 */
export async function startServer(app, REQUESTED_PORT, currentSettings) {
    let PORT;
 ...
 */
export function setupShutdownHandlers(server, browserConnector) {
 ...
 */
export async function initializeServer(app, REQUESTED_PORT, currentSettings) {
    try {
