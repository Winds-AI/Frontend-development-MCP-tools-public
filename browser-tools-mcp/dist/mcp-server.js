...
async function analyzeScreenshotWithAI(imageData, task) {
    try {
...
server.tool("captureBrowserScreenshot", "Captures current browser tab and analyzes it using AI based on your specific task. **Use for UI inspection, visual verification, or recursive UI improvement loops.** The AI will provide actionable insights about the current state of the UI.", {
