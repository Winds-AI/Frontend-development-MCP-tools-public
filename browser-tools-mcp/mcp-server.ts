...
server.tool(
  "api.request",
  "Execute a live HTTP request to API_BASE_URL; optionally include Authorization: Bearer API_AUTH_TOKEN. Use after 'api.searchEndpoints' or for known endpoints.",
  {
    endpoint: z
      .string()
      .describe(
