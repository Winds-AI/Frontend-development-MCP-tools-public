...
server.tool(
  "browser.screenshot",
  `Capture the current browser tab and return an image. Requires extension connection with DevTools open.
...
8) Plan two follow-up screenshots; capture via ui.interact with postActionScreenshot:true.`,
